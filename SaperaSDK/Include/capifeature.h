...
CORSTATUS CORAPIFUNC CorFeatureGetEnumValueEx(CORFEATURE feature, UINT32 index, PINT64 value);
...
CORSTATUS CORAPIFUNC CorFeatureGetEnumStringFromValueEx(CORFEATURE feature, INT64 value, PSTR enumString, UINT32 stringSize);
CORSTATUS CORAPIFUNC CorFeatureGetEnumValueFromString(CORFEATURE feature, PCSTR enumString, PUINT32 value);
CORSTATUS CORAPIFUNC CorFeatureGetEnumValueFromStringEx(CORFEATURE feature, PCSTR enumString, PINT64 value);
