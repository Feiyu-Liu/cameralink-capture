...
// Reserve these format definitions (no Sapera implementation yet)
#define CORDATA_FORMAT_DOUBLE       CORDATA_FORMAT( 1, 62, 64)
#define CORDATA_FORMAT_POINT_3D     CORDATA_FORMAT( 1, 63, 192)
...
#define CORDATA_FORMAT_IS_MONO_PLANAR(x) (										        \
...
#define CORDATA_FORMAT_IS_MULTI(x) (										                   \
   ...
   (CORDATA_FORMAT_IS_MONO_PLANAR(x))                                             || \
...
#define  CORPORT_TYPE_XTIUM2GIGEPX8CAMSIM 120
#define  CORPORT_TYPE_XTIUM3CLHSPX8       121
