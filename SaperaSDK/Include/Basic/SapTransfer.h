...
{
   SAP_FUNCNAME("SapXferPair::SetCallbackInfo");
   if (pCallback != NULL && IsBadReadPtr(pCallback, sizeof(SapXferCallback)))
      SAP_ERROR("Callback function argument has an invalid non NULL address", return FALSE);
   if (pContext != NULL && IsBadReadPtr(pContext, sizeof(void*)))
      SAP_ERROR("Context function argument has an invalid non NULL address", return FALSE);
...
{
   SAP_FUNCNAME("SapXferPair::SetTrashCallbackInfo");
   if (pCallback != NULL && IsBadReadPtr(pCallback, sizeof(SapXferCallback)))
      SAP_ERROR("Callback function argument has an invalid non NULL address", return FALSE);
   if (pContext != NULL && IsBadReadPtr(pContext, sizeof(void*)))
      SAP_ERROR("Context function argument has an invalid non NULL address", return FALSE);
