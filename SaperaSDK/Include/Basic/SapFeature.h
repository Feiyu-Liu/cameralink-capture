...
public:
   ...
   BOOL GetEnumValue(int enumIndex, INT64 *enumValue);
   ...
   BOOL GetEnumStringFromValue(INT64 enumValue, char *enumString, int enumStringSize);
   BOOL GetEnumValueFromString(const char *enumString, int *enumValue);
   BOOL GetEnumValueFromString(const char *enumString, INT64 *enumValue);
...
protected:
   ...
   BOOL m_Is64BitEnumValuesImplemented;
}; 
